...
exports.cleanUp = exports.initReceiver = exports.initRequester = void 0;
var constants_1 = require("../constants");
var params_1 = require("./params");
function initRequester(_a) {
    var url = _a.url, checkOrigin = _a.checkOrigin, data = _a.data, hook = _a.hook;
    if (window && document) {
...
function initReceiver(_a) {
    var _b, _c;
    var fromOrigin = _a.fromOrigin, checkOrigin = _a.checkOrigin, hook = _a.hook;
    if (window) {
        /**
         * Listen for transfer
         */
